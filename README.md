...
<table>
  <tr>
    <td align="center"><b>IC50 (mM) — концентрация, при которой вещество подавляет 50% активности вируса</b></td>
    <td align="center"><b>CC50 (mM) — концентрация, при которой вещество токсично для 50% клеток</b></td>
...
![5_210_features](images/rdme/5_210_features.png)
...
![6_missing](images/rdme/6_missing.png)
...
BCUT2D_MRLOW	        2
```
![7_result_miss](images/rdme/7_result_miss.png)

Мы намеренно оставили пропуски незаполненными.  

Модель потеряла бы информацию о том, что значение отсутствует. В химических дескрипторах факт отсутствия заряда сам по себе может быть сигналом о типе молекулы. Модели извлекают этот сигнал автоматически.
...
![8_assimetry](images/rdme/8_assimetry.png)

Целевые переменные имеют разные масштабы и выраженную правостороннюю асимметрию.  
Особенно выделяется SI: медиана равна 4, а максимум превышает 15600.  

![91_4](images/rdme/91_4.png)
![92_15600](images/rdme/92_15600.png)

Это говорит о наличии сильных выбросов, которые могут заметно влиять на RMSE.
...
![93_low_connect](images/rdme/93_low_connect.png)
![931_pic](images/rdme/931_pic.png)

## 6) Проверили константные и признаки с высокой корреляцией

![941_clean_dataset](images/rdme/941_clean_dataset.png)
...
![942_algoritm](images/rdme/942_algoritm.png)

# 4. Инженерия признаков

![943_fi](images/rdme/943_fi.png)
...
![945_gbst](images/rdme/945_gbst.png)
...
![946_minus](images/rdme/946_minus.png)
...
![947_graph](images/rdme/947_graph.png)
